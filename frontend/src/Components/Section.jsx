...
function Section({ imgUrl, heading, subheading, features }){
    return(
        <>
        <div
            className="bg-center bg-no-repeat bg-cover  h-[60vh] flex items-center justify-center"
            style={{ backgroundImage: `url(${imgUrl})`, opacity: 0.7 }}>
            <div className="text-center">
                {/* Heading */}
                <h1 className="lg:text-4xl md:text-2xl text-xl font-bold text-yellow-300">
                    {heading}
                </h1>
